...
uRNN_exmpl <- uRNN_fit(data_vars, data_label, data_flags, RNN_flags, paste(data_name, "_uModel"))
uRNN_exmpl$scores

#uModel_exmpl <- load_model_hdf5(paste0(data_name, "_uModel.h5"))
...
sRNN_exmpl <- sRNN_fit(data_vars, data_label, data_flags, RNN_flags, paste(data_name, "_sModel"))
sRNN_exmpl$scores

#sModel_exmpl <- load_model_hdf5(paste0(data_name, "_sModel.h5"))
